...
function progress()
{
    ...
    {
    rockProgress = (touchCount_Rock/10)* 100;
    progressBar.style.marginRight = (1 - (touchCount_Rock/10))* 100 + "%";
    progressText.innerHTML = "CRAFTING PROGRESS " + rockProgress + "%";
    }

    else if(readyForCraft_Stick)
    {
    stickProgress = (touchCount_Stick/10)* 100;
    progressBar.style.marginRight = (1 - (touchCount_Stick/10))* 100 + "%";
    ...
    {
        ButtonTool.innerHTML = "SEND AXE";
        ButtonTool.className = "Ready";
        ToolA.src = "images/axe_w_Done.png";
        ToolComplete = true;
    }
